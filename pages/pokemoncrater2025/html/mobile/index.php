...
<head><meta charset="UTF-8">
	...
	<style>
		.owl-theme .owl-controlls .owl-page span, .ui-btn-active {
...
<div data-role="page" id="home">
	...
	<ul data-role="listview" data-inset="false" data-theme="a">
		...
		<li><a data-transition="slide" href="#"><img src="assets/img/menu-icons/home.png" alt="Home" class="ui-li-icon">Home</a></li>
	...
	<div style="position: relative; top: 15px;">
		...
		<a href="http://plus.google.com/+pokemonvortex" target="_BLANK"><img src="assets/img/panel/google.png" alt="Google+"></a>
...
<div style="position: fixed; top: 0px;" data-role="panel" data-theme="a" data-position="right" data-display="push" id="right_panel">
	...
	<div id="homepage_content" data-role="content">
		...
		<div id="news_slider" class="owl-carousel owl-active homepage-slider">
				<div class="item">
					<a href="#">
						<img src="assets/img/content-images/1.png" alt="Pokemon Vortex">
					</a>
				</div>
				<div class="item">
					<a href="#">
						<img src="assets/img/content-images/2.png" alt="Pokemon Vortex">
					</a>
				</div>
				<div class="item">
					<a href="#">
						<img src="assets/img/content-images/3.png" alt="Pokemon Vortex">
					</a>
				</div>
		</div>
		<hr style="background: #bebebe;">
		<div class="container">
			<h3>Pok&eacute;mon Vortex Mobile</h3>
			<p>Sign up or log in to the mobile version of Pok&eacute;mon Vortex Battle Arena where you can catch, battle and trade all of your favourite Pok&eacute;mon online. And the best part is that it's completely free!</p>

<!------------------------------- Advert ---------------------------------------->

			<div class="advertisement-320-100">
				<!-- <img src="assets/img/adv-468-60.jpg" alt="Advertisement"> -->
			</div>
<!------------------------------- End Advert --------------------------------->
...
<!------------------------------- Key list of Vortex -------------------------------->
			...
			<div class="feature_wrap">
				...
				<div class="feature accent-color">
					<img src="assets/img/f_icon.png" alt="Feature 1">
				</div>
				<div class="feature_description">
					<h3>Why play on mobile?</h3>
					<p>The mobile version of Pok&eacute;mon Vortex is specifically designed and streamlined for your smartphone or tablet. This makes load times and your general play experience on mobile devices much more pleasant.<br />There are also exclusive mobile features that you won't see on the PC browser site.</p>
				</div>
				<hr style="background: #bebebe; margin: 15px 0px;">
			</div>
			<div class="feature_wrap">
				...
				<div class="feature_description">
					<h3>What's the differences between the two games, feature-wise?</h3>
					<p>Pok&eacute;mon Vortex's mobile mirror comes with extras that you will not see on the PC browser version. Some of these extras include limited events, Pok&eacute;mon and well... It's on the go.</p>
				</div>
				<hr style="background: #bebebe; margin: 15px 0px;">
			</div>
			<div class="feature_wrap">
				...
				<div class="feature_description">
					<h3>Does the mobile site have everything that the PC browser site has?</h3>
					<p>Currently - No. We're working on getting everything included but currently there are a few features not implemented. For more information on what's not yet added, please read our <a href="about.php">FAQ</a>.</p>
				</div>
				<hr style="background: #bebebe; margin: 15px 0px;">
			</div>

<!--------------------------- End key list of Vortex ----------------------------------------->
